...
For instance, a simple [contact us](https://app.cliosight.com/app/forms/36/show?noNavbar=true) form can be used instead of the usual landing page. A form is complete, except for the limitation that it can have only one submit button.         
